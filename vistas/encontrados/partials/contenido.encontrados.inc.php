...
<div class="row">
        <div class="col-md-12">
            <h3 >
                ...
                Avisos encontrados de <?= $categoria["cat_animal_descripcion"] ?> 
            </h3>
            <nav>
                <ol class="breadcrumb">
                    ...
                    ?>
                            ...
                            <li class="breadcrumb-item active">
                                <a href="index.php?m=encontrados&cat=<?= $categoria['id_cat_animal']?>"><?= $categoria['cat_animal_descripcion']?></a>
                            </li>
            ...
            <div class="row">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM publicacion WHERE id_cat_animal=" . $cat  . " AND id_tipo_publicacion=2";
